...
export class ProductCategory extends BaseEntity {
  ...
  @ManyToOne(() => Product, (product) => product.productCategories, { nullable: true })
  @JoinColumn({ name: 'productId' })
  product: Product;

  @ManyToOne(() => Category, (category) => category.productCategories, { nullable: true })
  @JoinColumn({ name: 'categoryId' })
  category: Category;

  @OneToMany(
    () => ProductCategoryTranslation,
    (productCategoryTranslations) => productCategoryTranslations.productCategory
  )
