...
export class UpdateDefaultLocalToMerchant1691373573229
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."merchant_defaultlocale_enum" AS ENUM('th', 'en', 'cn', 'tw', 'zh_TW', 'zh_CN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_locale_enum" AS ENUM('th', 'en', 'cn', 'tw', 'zh_TW', 'zh_CN')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_locale_enum_old" AS ENUM('th', 'en', 'cn', 'tw')`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ALTER COLUMN "locale" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."merchant_defaultlocale_enum_old" AS ENUM('th', 'en', 'cn', 'tw')`,
    );
    await queryRunner.query(
      `ALTER TABLE "merchant" ALTER COLUMN "defaultLocale" DROP DEFAULT`,
    );
