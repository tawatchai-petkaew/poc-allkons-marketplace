...
export class AddIndexToProduct1712460305863 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE SEQUENCE IF NOT EXISTS "merchant_application_configur_id_seq" OWNED BY "merchant_application_configuration_extra_large_ios_screenshot"."id"`,
    );
    await queryRunner.query(
      `ALTER TABLE "merchant_application_configuration_extra_large_ios_screenshot" ALTER COLUMN "id" SET DEFAULT nextval('"merchant_application_configur_id_seq"')`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "merchant_application_configuration_extra_large_ios_screenshot" ALTER COLUMN "id" DROP DEFAULT`,
    );
    await queryRunner.query(
      `DROP SEQUENCE "merchant_application_configur_id_seq"`,
    );
  }
}
