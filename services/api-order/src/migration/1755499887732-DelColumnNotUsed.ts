...
export class DelColumnNotUsed1755499887732 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_identity_documents" ALTER COLUMN "draftOrganizeId" SET NOT NULL`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a6f953d3ffe061cf2dbe0c8768" ON "user_identity_documents" ("draftOrganizeId") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_identity_documents" ALTER COLUMN "draftOrganizeId" DROP NOT NULL`,
    );
    await queryRunner.query(
