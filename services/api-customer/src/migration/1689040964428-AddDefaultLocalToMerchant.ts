...
export class AddDefaultLocalToMerchant1689040964428 implements MigrationInterface {
    name = 'AddDefaultLocalToMerchant1689040964428'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."merchant_defaultlocale_enum" AS ENUM('th', 'en', 'cn', 'tw')`);
        await queryRunner.query(`ALTER TABLE "merchant" ADD "defaultLocale" "public"."merchant_defaultlocale_enum" NOT NULL DEFAULT 'th'`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_locale_enum" AS ENUM('th', 'en', 'cn', 'tw')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_locale_enum_old" AS ENUM('th', 'en')`);
        await queryRunner.query(`ALTER TABLE "user" ALTER COLUMN "locale" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "merchant" ALTER COLUMN "availableLocale" SET DEFAULT '{en,th,cn}'`);
        await queryRunner.query(`ALTER TABLE "merchant" DROP COLUMN "defaultLocale"`);
