...
export class AddLocationSearchIndexes1761600000001 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_sub_district_zip_code"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_district_province_id"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_district_name_th_pattern"`
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_district_name_th_trgm"`
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_province_name_th_trgm"`
    );
