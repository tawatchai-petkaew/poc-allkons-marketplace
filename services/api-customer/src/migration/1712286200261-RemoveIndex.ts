...
export class RemoveIndex1712286200261 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_976ae0cbc46125630bfd1ecedd"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_976ae0cbc46125630bfd1ecedd" ON "merchant" ("slug") `);
