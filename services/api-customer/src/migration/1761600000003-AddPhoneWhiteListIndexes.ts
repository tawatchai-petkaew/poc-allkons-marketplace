...
export class AddPhoneWhiteListIndexes1761600000003 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_phone_country"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_org_active_created"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_created_at"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_is_active"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_label_pattern"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_label_trgm"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_phone_pattern"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_phone_white_list_phone_trgm"`);
