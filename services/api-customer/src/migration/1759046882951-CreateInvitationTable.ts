...
export class CreateInvitationTable1759046882951 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."invitations_status_enum" AS ENUM('NONE', 'SENT', 'ACCEPTED', 'DECLINED', 'EXPIRED', 'WAIT_FOR_APPROVE', 'CANCELLED', 'REJECTED')`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_invitation_ref_code" ON "invitations" ("refCode") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_organization_memberstatus_enum" AS ENUM('NONE', 'SENT', 'ACCEPTED', 'DECLINED', 'EXPIRED', 'WAIT_FOR_APPROVE', 'CANCELLED', 'REJECTED')`);
        ...
        await queryRunner.query(`ALTER TABLE "invitations" ADD CONSTRAINT "FK_e473b0cd56488ff0ac18b5ba284" FOREIGN KEY ("organizeId") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "invitations" DROP CONSTRAINT "FK_e473b0cd56488ff0ac18b5ba284"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_organization_memberstatus_enum_old" AS ENUM('ACCEPTED', 'DECLINED', 'EXPIRED', 'NONE', 'SENT', 'WAIT_FOR_APPROVE')`);
        await queryRunner.query(`ALTER TABLE "user_organization" ALTER COLUMN "memberStatus" DROP DEFAULT`);
