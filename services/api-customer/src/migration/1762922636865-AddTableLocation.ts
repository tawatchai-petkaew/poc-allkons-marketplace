...
export class AddTableLocation1762922636865 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_location_is_default" ON "location" ("isDefault") `);
        await queryRunner.query(`CREATE INDEX "idx_location_user_id" ON "location" ("userId") `);
        await queryRunner.query(`ALTER TABLE "location" ADD CONSTRAINT "FK_2a0d327b57744963f0733b4db76" FOREIGN KEY ("provinceId") REFERENCES "province"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "location" ADD CONSTRAINT "FK_7d7df9887609d88d47be93f17e7" FOREIGN KEY ("districtId") REFERENCES "district"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "location" ADD CONSTRAINT "FK_9168f51e3725c996ea0a84d0a55" FOREIGN KEY ("subDistrictId") REFERENCES "sub_district"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "location" DROP CONSTRAINT "FK_9168f51e3725c996ea0a84d0a55"`);
        await queryRunner.query(`ALTER TABLE "location" DROP CONSTRAINT "FK_7d7df9887609d88d47be93f17e7"`);
        await queryRunner.query(`ALTER TABLE "location" DROP CONSTRAINT "FK_2a0d327b57744963f0733b4db76"`);
