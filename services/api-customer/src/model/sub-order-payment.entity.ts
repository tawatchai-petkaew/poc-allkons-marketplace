import { BaseEntity, BeforeInsert, BeforeUpdate, Column, CreateDateColumn, DeleteDateColumn, Entity, Index, JoinColumn, ManyToOne, OneToMany, OneToOne, PrimaryGeneratedColumn, UpdateDateColumn } from 'typeorm';
...
export class SubOrderPayment extends BaseEntity {
  ...
  @ManyToOne(() => OrderPayment, (orderPayment) => orderPayment.subOrderPayments)
