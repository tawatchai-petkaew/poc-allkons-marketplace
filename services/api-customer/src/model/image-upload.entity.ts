...
export class ImageUpload extends BaseEntity {
  ...
  @OneToMany(() => Brand, (brands) => brands.imageUpload)
  brands: Brand[];

  @OneToMany(() => Category, (categories) => categories.imageUpload)
  categories: Category[];

  @OneToMany(
    () => MerchantProduct,
    (merchantProducts) => merchantProducts.imageUpload,
  )
  merchantProducts: MerchantProduct[];

  @OneToMany(
    () => ProductVariantImage,
    (productVariantImages) => productVariantImages.imageUpload,
  )
  productVariantImages: ProductVariantImage[];

  @OneToMany(
    () => ProductVariantDocument,
    (productVariantDocuments) => productVariantDocuments.imageUpload,
  )
