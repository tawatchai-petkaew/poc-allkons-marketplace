...
export class ImageUploadFolderService {
  ...
  public async create(dto: CreateImageUploadFolderDto) {
    const merchant = await this.merchantRepo.findOne(dto.merchantId);
  ...
  public async showAll(params): Promise<ImageUploadFolderDto[]> {
    const merchant = await this.merchantRepo.findOne(params.merchantId);
  ...
  public async update(
    ...
    const imageUploadFolder = await this.imageUploadFolderRepo.findOne(id);
  ...
  public async showAllFolder(merchantId: number): Promise<any[]> {
    const imageUploadFolders = await this.imageUploadFolderRepo
      .createQueryBuilder('imageUploadFolder')
