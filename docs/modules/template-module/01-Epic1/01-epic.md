...
**Maps to:** FR-001, FR-002, ... (list all related BRD functional requirements)
...
**Mandatory risk categories** — assess all 5 (see `docs/ai/skills/write-brd/SKILL.md` Step 4 §Risk Categories):
