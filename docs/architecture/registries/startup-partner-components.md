# Design System & Components: startup-partner-platform

> **Owner**: UI Developer (maintain), UX Designer + UI Developer (read before working)
> **Purpose**: One-stop reference for startup-partner-platform design system and components.
> **When to read**: Before `/write-ux-overview`, `/write-ux-spec`, or `/write-frontend-spec` for startup-partner-platform modules.

## 1. Design System Structure

### Folder Structure
- Design System Components: `apps/startup-partner-platform/src/design-system/components/` (folder-per-component)
- Barrel Export: `apps/startup-partner-platform/src/design-system/components/index.ts`
- Token Files: `apps/startup-partner-platform/src/design-system/tokens/`
- Icons: `apps/startup-partner-platform/src/design-system/components/icons/`
...
- Token source files:
  - `apps/startup-partner-platform/src/design-system/tokens/primitives.ts`
  - `apps/startup-partner-platform/src/design-system/tokens/alias.ts`
  - `apps/startup-partner-platform/tailwind.config.ts`
...
- Stories located in: `apps/startup-partner-platform/src/stories/`
