...
import { brand, errorColor, neutralColor, status, text, background, border, neutral, breadcrumbColor } from './src/design-system/tokens/alias';
    ...
    extend: {
      colors: {
        ...
        text: {
          ...
          'primary-hover':  text.primaryHover,
          secondary:        text.secondary,
          'secondary-hover': text.secondaryHover,
          ...
          white:            text.white,
          brand:            text.brand.default,      // #00AF43
          'brand-dark':     text.brand.dark,         // #008C36
          'brand-darker':   text.brand.darker,       // #006928
          'brand-light':    text.brand.light,        // #33BF69
          'brand-subtle':   text.brand.subtle,       // #E5F7EC
          'success':        text.success.default,
          'warning':        text.warning.default,
          'error':          text.error.default,
          'error-dark':     text.error.dark,
          'info':           text.info.default,
          // Breadcrumb — used by .ant-breadcrumb-link in globals.css
          breadcrumb:          breadcrumbColor.brand.textInactive,  // #37404F — inactive crumbs
          'breadcrumb-active': breadcrumbColor.brand.text,          // #008C36 — active (last) crumb
        },

        // ── Background ─────────────────────────────────────────────────────
        background: {
          primary:          background.primary,
          'primary-hover':  background.primaryHover,
          secondary:        background.secondary,
          'secondary-hover': background.secondaryHover,
          tertiary:         background.tertiary,
          solid:            background.solid,
          disabled:         background.disabled,
          'brand-subtle':   background.brand.subtle,
          'brand-default':  background.brand.default,
        },
        ...
        border: {
          ...
          brand:         border.brand.default,
          'brand-dark':  border.brand.dark,
          'brand-light': border.brand.light,
          'brand-lighter': border.brand.lighter,
          error:         border.error.default,
          'error-dark':  border.error.dark,
