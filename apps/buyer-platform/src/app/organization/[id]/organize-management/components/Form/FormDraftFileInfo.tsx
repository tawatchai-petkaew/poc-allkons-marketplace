      ...
      {isInPopup ? (
        ...
        <div className="fixed bottom-0 w-full inset-x-0 py-4 bg-white shadow-xl">
          {isMobile ? (
            ...
            <div className="w-full container flex flex-col-reverse md:flex-row gap-2 justify-between mx-auto">
              ...
              <div className="flex flex-col-reverse md:flex-row px-4 justify-end gap-2">
                <Button
                  variant="outlined"
                  bold="600"
                  onClick={() => {
