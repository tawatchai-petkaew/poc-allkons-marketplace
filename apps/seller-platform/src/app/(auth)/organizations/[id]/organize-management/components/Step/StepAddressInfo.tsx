...
interface StepAddressInfoData {
  addressIdCard?: AddressDetails;
  addressCurrent?: AddressDetails;
  addressTaxInvoice?: AddressDetails;
}

interface StepAddressInfoProps {
  addressInfoData: StepAddressInfoData | null;
  onEdit: () => void;
  onAdd: () => void;
  isDisabled: boolean;
}
