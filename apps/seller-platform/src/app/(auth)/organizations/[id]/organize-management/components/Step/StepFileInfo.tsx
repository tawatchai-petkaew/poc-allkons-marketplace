...
interface StepFileInfoData {
  COPY_OF_ID_OR_PASSPORT_AUTHORIZED_PERSON?: FileItem[];
  COPY_OF_HOUSE_REGISTRATION_AUTHORIZED_PERSON?: FileItem[];
  ID_CARD_WITH_PERSON?: FileItem[];
  PHOTO_OF_COMPANY_OR_PROJECT?: FileItem[];
  COPY_OF_BANK_ACCOUNT_RECEIVING_PAYMENTS?: FileItem[];
  COPY_OF_COMPANY_REGISTRATION?: FileItem[];
}

interface StepFileInfoProps {
  fileInfoData: StepFileInfoData | null;
  onEdit: () => void;
  onAdd: () => void;
  isDisabled: boolean;
...
const StepFileInfo = ({
  ...
  const renderFileNames = (files: { fileName: string }[]) => {
              ...
              <div className="flex flex-col gap-4 md:gap-6">
                <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                  <div className="w-full md:w-1/2 pr-4 flex flex-col gap-1">
                    ...
                    >
                      {renderFileNames(
                        (fileInfoData?.COPY_OF_ID_OR_PASSPORT_AUTHORIZED_PERSON as { fileName: string; }[]) ||
                          []
                      )}
                    </Typography>
                  </div>
                  <div className="w-full md:w-1/2 pr-4 flex flex-col gap-1">
                    ...
                    >
                      {renderFileNames(
                        (fileInfoData?.COPY_OF_HOUSE_REGISTRATION_AUTHORIZED_PERSON as { fileName: string; }[]) ||
                          []
                      )}
                    </Typography>
                  </div>
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                  ...
                  <div className="w-full pr-4 md:w-1/2 flex flex-col gap-1">
                    ...
                    >
                      {renderFileNames(
                        (fileInfoData?.PHOTO_OF_COMPANY_OR_PROJECT as { fileName: string; }[]) || []
                      )}
                    </Typography>
                  </div>
                </div>
                <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                  <div className="w-full md:w-1/2 flex flex-col gap-1">
                    ...
                    >
                      {renderFileNames(
                        (fileInfoData?.COPY_OF_BANK_ACCOUNT_RECEIVING_PAYMENTS as { fileName: string; }[]) ||
                          []
                      )}
                    </Typography>
                  </div>
              ...
              <div className="flex flex-col gap-4 md:gap-6">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-0">
                  <div className="w-full pr-4 md:w-1/2 flex flex-col gap-1">
                    ...
                    >
                      {renderFileNames(
                        (fileInfoData?.COPY_OF_COMPANY_REGISTRATION as { fileName: string; }[]) || []
                      )}
                    </Typography>
                  </div>
                  <div className="w-full md:w-1/2 flex flex-col gap-1">
