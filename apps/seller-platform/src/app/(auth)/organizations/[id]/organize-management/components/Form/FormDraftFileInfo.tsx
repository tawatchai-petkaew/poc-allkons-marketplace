...
import { OrganizationTypes } from "@/constants/enum/organization.enum";
...
export type FileInfoData = Record<string, FileItemData[]>;

interface FormDraftFileInfoProps {
  onClose: () => void;
  form: FormInstance;
  onFinish?: (values: Record<string, UploadFile[]>) => void;
  orgType?: string;
  draftOrganizeId: number;
  isInPopup?: boolean;
  onSaveDraft?: (val: Record<string, UploadFile[]>) => void;
...
const FormDraftFileInfo = ({
  ...
  useEffect(() => {
    ...
    Object.keys(fileInfoData).forEach((key) => {
      if (
        fileInfoData[key] &&
        Array.isArray(fileInfoData[key]) &&
        fileInfoData[key].length > 0
      ) {
        convertedFiles[key as keyof FileValues] = fileInfoData[key].map(
          (file: FileItemData, index: number) => ({
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <Typography variant="paragraph-big" className="!text-text-primary">
            ขั้นตอนที่ 4 : เอกสารยืนยันองค์กร
          </Typography>
        </div>
        <Alert
          message={
        ...
        <div className="p-6 border border-border-primary rounded-xl flex flex-col gap-6">
          ...
          >
            <UploadFileDragger
              ...
              dataTestId="organization-file-id-or-passport-owner"
            />
          </Form.Item>
          <Form.Item
          ...
          >
            <UploadFileDragger
              ...
              dataTestId="organization-file-house-registration-owner"
            />
          </Form.Item>
          {(orgType === OrganizationTypes.PERSONAL ||
            ...
            >
              <UploadFileDragger
                ...
                dataTestId="organization-file-owner-with-id-photo"
              />
            </Form.Item>
          )}
          <Form.Item name="POWER_OF_ATTORNEY" className="!mb-0">
            <UploadFileDragger
              ...
              dataTestId="organization-file-power-of-attorney"
            />
          </Form.Item>
          <Form.Item
          ...
          >
            <UploadFileDragger
              ...
              dataTestId="organization-file-grantor-or-attorney-id"
            />
          </Form.Item>
        </div>
        <div className="flex flex-col mt-4">
        ...
        <div className="p-6 border border-border-primary rounded-xl flex flex-col gap-6">
          ...
          >
            <UploadFileDragger
              ...
              dataTestId="organization-file-business-registration"
            />
          </Form.Item>
          <Form.Item name="COPY_OF_VAT_REGISTRATION" className="!mb-0">
            <UploadFileDragger
              ...
              dataTestId="organization-file-vat-pp-20"
            />
          </Form.Item>
          <Form.Item name="TRADEMARK" className="!mb-0">
            <UploadFileDragger
              ...
              dataTestId="organization-file-trademark"
            />
          </Form.Item>
          <Form.Item
          ...
          >
            <UploadFileDragger
              label="4. รูปถ่ายสถานที่ประกอบกิจการ"
              ...
              dataTestId="organization-file-business-place-photos"
            />
          </Form.Item>
        </div>
        <div className="flex flex-col mt-4">
        ...
        <div className="p-6 border border-border-primary rounded-xl flex flex-col gap-6">
          ...
          >
            <UploadFileDragger
              ...
              dataTestId="organization-file-finance-input"
            />
          </Form.Item>
        </div>
        <div className="flex flex-col mt-4">
        ...
        <div className="p-6 border border-border-primary rounded-xl flex flex-col gap-6">
          <Form.Item name="OTHERS" className="!mb-0">
            <UploadFileDragger
              ...
              dataTestId="organization-file-others-docs-input"
            />
          </Form.Item>
        </div>
      </div>
      {isInPopup ? (
        ...
        <div className="fixed bottom-0 w-full inset-x-0 py-4 bg-white shadow-xl z-[11]">
          <div className="w-full container flex gap-2 justify-between mx-auto px-4 md:px-0">
            ...
            <div className="flex justify-end gap-2 w-full md:w-auto">
              <Button
                ...
                onClick={() => {
                  if (onSaveDraft) {
                    onSaveDraft(form.getFieldsValue());
                  }
                }}
