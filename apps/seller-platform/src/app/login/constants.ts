...
// ===== Initial State =====
// MOCKED: Starting at SET_ORGANIZATION step for testing
// export const INITIAL_AUTH_STATE: AuthState = {
//   flow: "register",
//   currentStep: Step.SET_ORGANIZATION,
//   phoneNumber: "0812345678", // Mock phone number
//   otpData: { token: "mock-token", refNo: "MOCK123" },
//   password: "Test1234",
...
//     authCenter: {
//       accessToken: "mock-auth-center-access-token-67890",
//       expiresIn: "3600",
//       refreshExpiresIn: 86400,
//       refreshToken: "mock-refresh-token-54321",
//     },
//   },
//   existingRegisteredIndividualOrgs: null,
//   existingJuristicOrgs: null,
// };

// Original state (commented out):
export const INITIAL_AUTH_STATE: AuthState = {
  flow: "login",
...
export const ERROR_MESSAGES = {
  ...
  OTP_BLOCKED_MESSAGE: (flow: string) =>
    flow === "login"
      ? "เพื่อทำการเข้าสู่ระบบอีกครั้ง"
